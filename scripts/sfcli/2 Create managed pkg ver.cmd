...
sf package version create --installation-key-bypass --package=0Hoak0000002HsnCAE --wait="20" --version-description="List all the email alerts in your org" --version-name="Final" --code-coverage --path="force-app" --verbose --target-dev-hub="mr.jcrm.devhub@gmail.com" --tag="gitid 1234567" --releasenotes-url="https://github.com/mrjcrm/Export-Email-Alerts"